...
h1,h2,h3{font-family:'Pacifico',cursive;font-weight:400;color:var(--ink);line-height:1.2;margin:0 0 .6rem}
h1{font-size:clamp(2.2rem,5vw,3.6rem)}h2{font-size:2rem;position:relative;padding-bottom:.5rem;margin-top:0}
...
.top a{color:#fff;text-decoration:none;font-family:'Open Sans',sans-serif;letter-spacing:.04em;font-weight:700;font-size:.9rem}
...
.eyebrow{display:inline-block;font-family:'Open Sans',sans-serif;text-transform:uppercase;letter-spacing:.12em;font-weight:700;color:var(--teal);background:var(--teal-soft);border-radius:999px;padding:.25rem .8rem;font-size:.72rem;margin-bottom:1rem}
...
th{font-family:'Open Sans',sans-serif;text-transform:uppercase;letter-spacing:.1em;font-size:.75rem;color:var(--ink);background:#f3f6f6}
th.schole{color:var(--teal)}td.row{font-weight:600;color:var(--ink);width:11rem}
td.schole{background:#f5fafa}
tr:last-child td{border-bottom:0}
.win{display:inline-block;font-family:'Open Sans',sans-serif;text-transform:uppercase;letter-spacing:.1em;font-size:.62rem;font-weight:700;color:var(--win);background:var(--win-soft);border-radius:4px;padding:.05rem .4rem;margin-left:.4rem;vertical-align:middle}
...
<link href="https://fonts.googleapis.com/css2?family=Pacifico&family=Open+Sans:wght@400;600;700&display=swap" rel="stylesheet">
